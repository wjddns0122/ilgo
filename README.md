...
`capture/` 폴더에 있는 앱 화면 캡처 29장을 실제 사용 흐름에 맞춰 정리했습니다.
...
홈 화면에서 종이 문서를 촬영하거나 화면 캡처를 넣을 수 있습니다. 최근 분석 기록과 기한이 임박한 항목도 함께 보여서, 놓치기 쉬운 일을 먼저 확인할 수 있습니다.

<p>
<img src="capture/home_main.png" width="210" alt="메인 홈 화면">
<img src="capture/home_deadline_alert.png" width="210" alt="메인 홈 기한 알림 화면">
</p>
